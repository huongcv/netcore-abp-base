...
export const Filter3Icon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
        <g>
            <g id="Filter">
                <path id="Stroke 1" fillRule="evenodd"
                      clipRule="evenodd"
