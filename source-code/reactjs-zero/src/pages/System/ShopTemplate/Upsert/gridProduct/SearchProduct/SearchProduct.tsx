...
import SearchProductTableModal
    from "@pages/System/ShopTemplate/Upsert/gridProduct/SearchProduct/SearchProductTableModal";
...
const SearchProduct = (props: {
    ...
    return (
        <>
            <Row gutter={16}>
                <Col flex="1 1 150px">
                    <ProductSelectSearchApi onProductSelected={onProductSelected}
                                            onlyGetProductUsingInventory={props.onlyGetProductUsingInventory}
