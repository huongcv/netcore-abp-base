...
const RoleCreateOrUpdateForm = (props: {
    ...
    const {roleListStore: mainStore} = useStore();
        ...
        children: (<Row gutter={18}>
            <Col span={18}>
                <FloatLabel label={t('code')}
                            required>
                    <Form.Item
                        name='code' rules={[ValidateUtils.required]}>
                        <Input maxLength={100} disabled={mode !== 'addNew'}/>
                    </Form.Item>
                </FloatLabel>
            </Col>
            <Col span={6}>
                <Form.Item noStyle name='isActived' valuePropName="checked">
