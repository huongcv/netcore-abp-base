...
function ReportSupplierProduct() {
    const {supplierReportProduct: stored} = useStore();
                            ...
                            <Table.Summary fixed='top'>
                                <Table.Summary.Row>
                                    ...
                                    <Table.Summary.Cell index={1} align='right'
                                        ...
                                        {formatterNumber(summaryData?.moveQty, 0)}
                                    </Table.Summary.Cell>
                                    <Table.Summary.Cell index={2} align='right'
                                                        className='font-bold  !pr-1.5'>
                                        {formatterNumber(summaryData?.totalAmount, 0)}
                                    </Table.Summary.Cell>
                                    <Table.Summary.Cell index={3} align='right'
                                                        className='font-bold  !pr-1.5'>
                                        {formatterNumber(summaryData?.returnQty, 0)}
                                    </Table.Summary.Cell>
                                    ...
                                    <Table.Summary.Cell index={5} align='right'
                                                        className='font-bold  !pr-1.5'>
                                        {formatterNumber(summaryData?.totalMove, 0)}
                                    </Table.Summary.Cell>
...
export default observer(ReportSupplierProduct);
