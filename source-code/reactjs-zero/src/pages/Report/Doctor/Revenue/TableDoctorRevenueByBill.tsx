...
import {DoctorRevenueByBillReportDto, DoctorRevenueByMoneyReportDto} from "@api/index.defs";
import DateUtil from "@ord-core/utils/date.util";
import {observer} from "mobx-react-lite";
import {AntTableWithDataPaged} from "@ord-components/table/AntTableWithDataPaged";

const TableDoctorRevenueByMoney = (props: {
    ...
    const {summaryData}: {summaryData: DoctorRevenueByBillReportDto} = stored;
    return (
        <div>
                            ...
                            <Table.Summary fixed='top'>
                                <Table.Summary.Row>
                                    ...
                                    <Table.Summary.Cell index={4} align='right'
                                                        className='font-bold !pr-1.5'>
                                        {formatterNumber((summaryData?.taxAmount ?? 0) * -1, 0)}
                                    </Table.Summary.Cell>
...
export default observer(TableDoctorRevenueByMoney);