...
import {DoctorProfitByBillReportDto} from "@api/index.defs";
import DateUtil from "@ord-core/utils/date.util";
import {observer} from "mobx-react-lite";
import {AntTableWithDataPaged} from "@ord-components/table/AntTableWithDataPaged";

const TableDoctorProfitByMoney = (props: {
    ...
    const {summaryData}: {summaryData: DoctorProfitByBillReportDto} = stored;
    return (
        <div>
...
export default observer(TableDoctorProfitByMoney);