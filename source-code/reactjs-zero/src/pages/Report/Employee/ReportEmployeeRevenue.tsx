...
import {EmployeeRevenueReportDto} from "@api/index.defs";
...
function ReportEmployeeRevenue() {
    const {employeeReportRevenue: stored} = useStore();
    ...
    const columns: TableColumnsType<any> = TableUtil.getColumns([
        {
            ...
            title: 'employeeName',
            width: 150,
            render: (data: string, record: EmployeeRevenueReportDto) => {
                return <strong>{record.employeeName}</strong>
            }
        },
        {
...
export default observer(ReportEmployeeRevenue);
