...
const topAction: IActionBtn[] = [
    ...
    {
        content: (
            <Button  style={{ background: 'var(--main-color)', color: 'white' }} icon={<SaveOutlined />}>Lưu</Button>
        )
    }
];
...
const EditReservation = () => {
    ...
    return (
        <>
            ...
            >
                <OrdBreadcrumb mainTitle={"Chỉnh sửa đặt bàn"} itemsRoute={[{ title: "Đặt bàn", route: "/restaurant/book" }]} />
                    ...
                    <Card title="Thông tin khách hàng" className="mb-4">
                        <Form layout="vertical">
                            <Row gutter={24}>
                                ...
                                <Col span={12}>
                                    <FloatLabel label={"Số điện thoại"} required={true}>
                            ...
                            <Form.Item name="specialRequests">
                                <Checkbox.Group>
                                    <Space direction="vertical">
                                        <Checkbox value="birthday">Tổ chức sinh nhật</Checkbox>
                                        <Checkbox value="rotatable">Bàn có thể xoay</Checkbox>
