...
export const SalesPromotionRouter: OrdRouterItem[] = [
  {
    path: AppExtendCode.restaurant+ "/product/sales-promotion",
    lazyComponent: lazy(
  ...
  {
    path: AppExtendCode.restaurant+ "/product/sales-promotion/create-update",
    lazyComponent: lazy(
  ...
  {
    path: AppExtendCode.restaurant+ "/product/sales-promotion/create-update/:id",
    lazyComponent: lazy(
      () => import("@pages/ProductManagement/SalesPromotion/CreateOrUpdate")
    ),
    permission: PERMISSION_APP.product.salesPromotion,
