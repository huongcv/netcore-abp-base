...
import ProductDetailModal from "@pages/StockManagement/ImportStock/FormUpsert/ProductDetailModal";
import {StockProductSelectDto} from "@api/index.defs";
...
const ImportProductItemTable = () => {
    ...
    const remove = (dto: StockProductSelectDto) => {
        UiUtils.showConfirm({
            ...
            onOk: (d) => {
                const index = productItems.findIndex(x => x.uuid === dto.uuid);
        ...
        <>
            <Table pagination={{
                ...
                onChange: (page, pageSize) => {
                   ...
                   locale={{
                       emptyText: (
                           <ImportStockUploadExcel moveType={MoveType.PhieuNhapNhaCungCap}/>
                       )
                   }}
