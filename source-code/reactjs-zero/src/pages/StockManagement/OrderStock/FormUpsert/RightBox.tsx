...
import ProductItems = StockMoveFormName.ProductItems;
...
const OrderRightBox = (props: IRightBoxProp) => {
            ...
            <Row gutter={16}>
                ...
                <Col span={24}>
                    <FloatLabel label={t('desiredDeliveryDate')}>
                        <Form.Item name={'desiredDeliveryDate'} rules={[ValidateUtils.requiredShortMess]}
                                   initialValue={today}>
                            <OrdDateInput />
                        </Form.Item>
                    </FloatLabel>
...
export default observer(OrderRightBox);
