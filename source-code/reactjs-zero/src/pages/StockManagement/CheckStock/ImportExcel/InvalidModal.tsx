...
const ErrorCell = (props: {
    dto: ImportExcelCheckExcelBaseDto
}) => {
...
export const InvalidModalCheckStock = (props: {
    invalidList: ImportExcelCheckExcelBaseDto[],
    validList: ImportExcelCheckExcelBaseDto[],
    onAddListValid?: () => void,
    moveType?: MOVE_TYPE,
    isModalOpen: boolean,
    ...
    const columns: ColumnType<ImportExcelCheckExcelBaseDto>[] = [
        {
            key: 'detailError',
            title: t('detailError'),
            width: 200,
        ...
        },
        {
            ...
            dataIndex: 'closingInventoryQtyStr',
            align: 'right',
            width: 100,
        },
