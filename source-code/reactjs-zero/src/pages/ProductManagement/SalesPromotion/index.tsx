      ...
      actions: [
        {
          ...
          onClick: (p) => {
            navigate(
              pathNameRef.current +
                `/sales-promotion/create-update/${p.id}?action=${ACTION.View}`
            );
          },
        },
        {
          ...
          onClick: (p) => {
            navigate(
              pathNameRef.current +
                `/sales-promotion/create-update/${p.id}?action=${ACTION.Update}`
            );
          },
        },
  ...
  const topActions: IActionBtn[] = [
    {
      ...
      onClick: () => {
        navigate(pathNameRef.current + "/sales-promotion/create-update");
      },
    },
  ];
  const SearchForm = () => {
