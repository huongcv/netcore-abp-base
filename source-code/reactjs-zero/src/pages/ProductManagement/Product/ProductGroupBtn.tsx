...
import {FileExcelOutlined, PlusOutlined, UnorderedListOutlined, UploadOutlined,} from "@ant-design/icons";
...
const ProductGroupBtn = () => {
    ...
    const pathNameRef = useRef<string>(Utils.getPathUpTo('/product-group'));
    const items: MenuProps["items"] = [
        ...
        },
        {
            key: "2",
            label: (
                <Link to={pathNameRef.current + "/import-excel"}>
          <span>
