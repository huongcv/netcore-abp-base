...
import {PACKAGE_TEST_CODE, TaxCodeNotUse} from "@ord-core/AppConst";
import {BusinessTypeEnum} from "@ord-core/service-proxies/session/dto";
import {
    useSelectPersonalIncomeTaxCode
} from "@ord-components/forms/select/selectDataSource/useSelectPersonalIncomeTaxPercent";
...
export const ProductBaseInformationGroup = (props: Props) => {
    ...
    const isPackageTest =  PACKAGE_TEST_CODE.some(x => x === sessionStore?.user?.packageRegistrationCode);
            ...
            <Row gutter={8}>
                <Col lg={20} sm={24}>
                    <Row gutter={8}>
                        ...
                        <ColSpanResponsive span={isProductPriceIncludeTax_w && sessionStore.businessType === BusinessTypeEnum.BusinessHouseholds ? 5 : 10}>
                            <FloatLabel
                        ...
                        {
                            sessionStore.businessType === BusinessTypeEnum.BusinessHouseholds &&
                            <ColSpanResponsive span={5}>
                                <FloatLabel label={t("PersonalIncomeTaxPercent")}>
                                    <Form.Item name="personalIncomeTaxCode" initialValue={TaxCodeNotUse}>
                                        <OrdSelect allowClear={false}
                                                   onChange={(data, option: IOrdSelectOption) => {
                                                       form.setFieldValue("personalIncomeTaxPercent", option.data?.taxPercent);
                                                   }}
                                                   datasource={useSelectPersonalIncomeTaxCode()}/>
                                    </Form.Item>
                                    <Form.Item hidden noStyle name="personalIncomeTaxPercent" initialValue={0} />
                                </FloatLabel>
                            </ColSpanResponsive>
                        }
                        ...
                        <ColSpanResponsive span={isDrugItem() ? 16 : 24}>
                            <FloatLabel label={t("ProductGroup")}>
                                <Form.Item name="listProductGroupId">
                                    <SelectAddNewProductGroup maxTagCount={3}/>
                                </Form.Item>
                            </FloatLabel>
                        </ColSpanResponsive>
                        {isProductUseInventory_w && (
                ...
                <Col lg={4} sm={24}>
                    <Row gutter={[8, 8]}>
                        ...
                        {
                            productTypeId_w !== ProductTypeEnum.DichVu && !isPackageTest &&
                            <>
                                <ColSpanResponsive span={24}>
                                    <Form.Item
                                        noStyle
