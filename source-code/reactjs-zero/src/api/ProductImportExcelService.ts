import {
  ...
  ValidateInputDto,
  ValidateProductImportResultOfProductImportDto,
  FileUploadDto,
  ProductImportDto,
  ProductTypeEnum,
  ProductDrugDto,
  ProductUnitImportDto,
  ProductImportLotNumberDto,
  InsertProductCommand,
  CommonResultDtoOfProductCreateImportResponseDtoOfProductImportDto,
  ProductCreateImportResponseDtoOfProductImportDto,
  boolean,
  CommonResultDtoOfValidateProductImportResultOfProductImportKiotVietDto,
  ValidateProductImportResultOfProductImportKiotVietDto,
  ProductImportKiotVietDto,
  InsertProductKiotVietCommand,
  CommonResultDtoOfProductCreateImportResponseDtoOfProductImportKiotVietDto,
  ProductCreateImportResponseDtoOfProductImportKiotVietDto,
  IList,
  List,
  IListResult,
  ListResultDto,
