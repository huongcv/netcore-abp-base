...
export class RoleHostService {
  ...
  static create(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/create';
  ...
  static update(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/update';
  ...
  static setPermission(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/set-permission';
  ...
  static getPaged(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/get-paged';
  ...
  static getCount(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/get-count';
  ...
  static getById(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/get-by-id/{findId}';
  ...
  static remove(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/remove/{removeId}';
  ...
  static getListUserAssignByRole(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/get-list-user-assign-by-role';
  ...
  static unassignUser(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/unassign-user';
  ...
  static getListPermission(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/get-list-permission';
  ...
  static getComboOptions(options: IRequestOptions = {}): Promise<ComboOptionDto[]> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/auth-plugin/role-host/get-combo-options';
