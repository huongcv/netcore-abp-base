...
export class MoveReasonTypeService {
  ...
  static getPaged(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/get-paged';
  ...
  static getById(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/get-by-id/{findId}';
  ...
  static createOrUpdate(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/create-or-update';
  ...
  static remove(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/remove/{removeId}';
  ...
  static exportPagedResult(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/export-paged-result';
  ...
  static getComboOptions(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/get-combo-options';
  ...
  static clearCache(options: IRequestOptions = {}): Promise<any> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/pos/move-reason-type/clear-cache';
