...
export class GolfCaddyGroupService {
  ...
  static getPaged(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/get-paged';
  ...
  static getCount(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/get-count';
  ...
  static getById(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/get-by-id/{findId}';
  ...
  static getComboOptions(options: IRequestOptions = {}): Promise<ComboOptionDto[]> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/get-combo-options';
  ...
  static exportPagedResult(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/export-paged-result';
  ...
  static import(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/import';
  ...
  static validateImport(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/validate-import';
  ...
  static exportTemplate(options: IRequestOptions = {}): Promise<any> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/export-template';
  ...
  static createOrUpdate(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/create-or-update';
  ...
  static remove(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/remove/{removeId}';
  ...
  static removeByHashId(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/remove-by-hash-id/{hashId}';
  ...
  static clearCache(options: IRequestOptions = {}): Promise<any> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-caddy-group/clear-cache';
