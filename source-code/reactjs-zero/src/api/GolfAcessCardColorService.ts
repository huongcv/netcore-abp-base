...
export class GolfAcessCardColorService {
  ...
  static getPaged(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-acess-card-color/get-paged';
  ...
  static createOrUpdate(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-acess-card-color/create-or-update';
  ...
  static remove(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-acess-card-color/remove/{removeId}';
  ...
  static getById(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-acess-card-color/{id}/get-by-id';
  ...
  static getComboOptions(options: IRequestOptions = {}): Promise<ComboOptionDto[]> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-acess-card-color/get-combo-options';
  ...
  static clearCache(options: IRequestOptions = {}): Promise<any> {
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/golf/golf-acess-card-color/clear-cache';
