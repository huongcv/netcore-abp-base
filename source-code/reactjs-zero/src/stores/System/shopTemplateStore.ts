...
import {IRequestOptions, ShopTemplateDto, StockInventoryDto} from "@api/index.defs";
...
class ShopTemplateStore extends CommonListStore<ShopTemplateDto, ShopTemplateDto> {
    ...
    apiService() {
        return {
            getPaged: ShopTemplateService.getPaged,
...
export default ShopTemplateStore;
