...
class TenantRoleTemplateListStore extends CommonListStore<UserDto> {
    ...
    apiService() {
        return {
            getPaged: (params: { body: any }, options: IRequestOptions) => {
                params.body.isTemplateTenant = true; 
                return RoleHostService.getPaged(params);
            },
...
export default TenantRoleTemplateListStore;
